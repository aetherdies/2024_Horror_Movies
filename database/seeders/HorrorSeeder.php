...
class HorrorSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($horror as $horrorData)
        {
            $horror = Horror::create(array_merge($horrorData, ['created_at' => $currentTimestamp, 'updated_at' => $currentTimestamp]));

            $director = Director::inRandomOrder()->take(2)->pluck('id');

            $horror->director()->attach($director);
        }
    }
}
